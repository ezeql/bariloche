...
// // 		schemas, err := snowflake.ListSchemas(db.DBName.String, sdb.DB)
// // 		if err != nil {
// // 			log.Fatalf("error:  %v", err)
// // 		}

// // for _, schema := range schemas {
// // 	tables, err := snowflake.ListTables(schema.DatabaseName.String, schema.Name.String, sdb.DB)
// // 	if err != nil {
// // 		log.Fatalf("error:  %v", err)
...
// // 				builder := snowflake.Table(table.TableName.String, table.DatabaseName.String, table.SchemaName.String)

// // 				// row := snowflake.QueryRow(sdb.DB, builder.Show())
...
// // 				// Describe the table to read the cols
// // 				tableDescriptionRows, err := snowflake.Query(sdb.DB, builder.ShowColumns())
// // 				if err != nil {
// // 					// return err
// // 					return
// // 				}
